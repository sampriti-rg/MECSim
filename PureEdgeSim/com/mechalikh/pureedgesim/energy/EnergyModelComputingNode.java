...
public class EnergyModelComputingNode {
	...
	public void updateStaticEnergyConsumption() {
		//System.out.println((getIdleConsumption() / 3600 * SimulationParameters.UPDATE_INTERVAL) +":"+(3600 * SimulationParameters.UPDATE_INTERVAL)+ ":"+SimulationParameters.UPDATE_INTERVAL);
	...
	public void updateDynamicEnergyConsumption(double mipsCapacity, double mipsRequirement, double latency) {
		...
		* */
		cpuEnergyConsumption += (0.1 * (mipsRequirement*mipsRequirement)/(mipsCapacity*mipsCapacity)*latency)/3600; //alpha = 0.1
	}
