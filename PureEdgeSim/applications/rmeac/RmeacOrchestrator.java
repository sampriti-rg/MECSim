...
public class RmeacOrchestrator extends Orchestrator {
    double startTime = 0;
    double failStartTime = 0;
    private SimulationManager simManager;
    public RmeacOrchestrator(SimulationManager simulationManager) {
    ...
    public void resultsReturned(Task task) {
        RmeacSimManager customSimMananger = (RmeacSimManager) simManager;
        TaskNode taskNode = (TaskNode) task;
...
//        this.simulateFailures(5, currentTime);
//
